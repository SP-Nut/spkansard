  ...
  return (
    <section className="rounded-3xl border border-slate-200 bg-white p-4 shadow-sm sm:p-6">
      ...
      <div className="mt-5 grid gap-4 md:grid-cols-[1fr_260px]">
        ...
        <div className="rounded-3xl bg-[#30318B] p-5 text-white">
          <FaRulerCombined className="h-6 w-6 text-[#00A2EA]" />
      ...
      <div className="mt-4 grid gap-3 rounded-3xl border border-[#00A2EA]/20 bg-[#f4fbff] p-4 sm:grid-cols-[auto_1fr]">
        <div className="grid h-12 w-12 place-items-center rounded-2xl bg-white text-[#00A2EA]">
          <FaImage />
        </div>
        <div>
          <h3 className="font-black text-[#202166]">ไม่แน่ใจขนาดพื้นที่?</h3>
