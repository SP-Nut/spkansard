...
const faqs = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer: "มีครับ เรารับประกันคุณภาพงานติดตั้ง 1 ปี และวัสดุตามเงื่อนไขของผู้ผลิต พร้อมบริการหลังการขายและซ่อมบำรุง รายละเอียดเพิ่มเติมสามารถ<a href='/contact' class='text-blue-600 hover:text-blue-800 underline'>ติดต่อสอบถาม</a>ได้"
      },
      {
    ...
    questions: [
      {
        ...
        answer: "เรามีกันสาดหลายประเภท ได้แก่ กันสาดผ้าใบ กันสาดโพลีคาร์บอเนต กันสาดเหล็ก และกันสาดอลูมิเนียม แต่ละประเภทมีข้อดีและการใช้งานที่แตกต่างกัน ดูข้อมูลเพิ่มเติมได้ที่หน้า <a href='/materials' class='text-blue-600 hover:text-blue-800 underline'>วัสดุ</a>"
      },
      {
        question: "กันสาดใช้งานได้นานแค่ไหน?",
        answer: "อายุการใช้งานขึ้นอยู่กับวัสดุและการดูแลรักษา โดยทั่วไปกันสาดเหล็กและอลูมิเนียมสามารถใช้งานได้ 10-15 ปี ส่วนกันสาดผ้าใบ 3-5 ปี ดู<a href='/materials' class='text-blue-600 hover:text-blue-800 underline'>ข้อมูลวัสดุ</a>เพิ่มเติม"
      },
      {
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer: "มีให้เลือกหลากหลาย เช่น โพลีคาร์บอเนต กระเบื้องเหล็ก แผ่นเหล็กลูกฟูก หรือกระเบื้องคอนกรีต แต่ละแบบมีข้อดีและราคาแตกต่างกัน ดูรายละเอียด<a href='/materials' class='text-blue-600 hover:text-blue-800 underline'>วัสดุที่ใช้งาน</a>ทั้งหมด"
      },
      {
